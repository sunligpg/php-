        ...
        *{
        ...
        .modal {
            display: none; /* Hidden by default */
             /*display是顯示 */ /*none是不顯示*/ /*display: none;是不顯示*/
            position: fixed; /* Stay in place */
            z-index: 1; /* Sit on top */  /* z-index: 1;永遠保持在上方 */
            right: 50; /*  right靠右 */
            top: 50; /*  top 靠上*/
            width: 20%; /* Full width */
            height: 20%; /* Full height */
            overflow: auto; /* Enable scroll if needed */ /*  overflow 一個數值運算結果超出了能夠存儲在變數中的範圍*/
            background-color: rgba(255,255,255,0.9); /* Black w/ opacity */
            padding-top: 50px;  /* Full height 設置的是內容區域頂部的內邊距 */ 
        }  /*登入畫面css*/
        /*佈告欄*/
        .bulletin{
            display: block;
            ...
            <div class="container">
                ...
                <div class="top-nav">
                  ...
                  <label onclick="document.getElementById('login').style.display='block'">登入</label>
                   <!---label是普通標籤 --> 
                  <!---document要找出getElementById('login')是在249行至256行style.display='block' -->
                  <!---style.display='block'是顯示出來，display='block'是秀出來 -->
        ...
        <div class="bulletin">
           <h1>最新公告</h1>
            <?php
                ...
                //$result=mysqli_query($conn, "select * from bulletin limit 4 ");顯示前四個
